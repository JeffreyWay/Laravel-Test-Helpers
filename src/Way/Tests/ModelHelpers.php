...
trait ModelHelpers {
    ...
    {
        $this->assertHasMethod('validate', $model, "The 'validate' method does not exist on this model.");
    ...
    public function assertHasMethod($method, $class, $message = null)
    {
    ...
    {
        $this->assertHasMethod($relationship, $class);
